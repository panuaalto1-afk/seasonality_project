...
UPDATED: 2025-11-10 16:50 UTC - Fixed 'score' field, VIX symbol
"""
...
class RegimeCalculator:
    ...
    def calculate_regime(self, target_date: date) -> Dict:
        ...
        return {
            'date': target_date,
            'regime': regime,
            'score': composite_score,  # ← FIXED: Always include score
            'components': {
                'equity': equity_score,
    ...
    def _calculate_volatility_component(self, target_date: date) -> float:
        ...
        # NOTE: VIXM removed (not available)
